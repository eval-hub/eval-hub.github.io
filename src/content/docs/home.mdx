...
<CardGrid>
  ...
  <Card title="MLflow Integration" icon="open-book">
    Track experiments, compare runs, and persist metrics to [MLflow](/guides/mlflow/) automatically.
  </Card>
</CardGrid>
...
- **[MLflow](/guides/mlflow/)** experiment tracking for jobs and adapters
- **[Prometheus metrics and OpenTelemetry](/guides/opentelemetry/)** tracing, metrics, and logs
...
<CardGrid>
  ...
  <LinkCard title="MLflow" href="/guides/mlflow/" description="Configure experiment tracking for jobs and adapters" />
