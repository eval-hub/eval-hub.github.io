...
Platform administrators update system collections through the Git-managed YAML and Operator ConfigMap workflow. See [Administration](/guides/administration/).
