...
Platform administrators update system collections through version-controlled YAML and the Operator-managed ConfigMap workflow. See [System resource configuration](/administration/system-resource-configuration/).
...
:::note
The server applies the collection's weight, primary score, or pass criteria for aggregate scoring.
:::
